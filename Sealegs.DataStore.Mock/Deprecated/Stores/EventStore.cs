...
namespace Sealegs.DataStore.Mock
{
    public class EventStore : BaseStore<FeaturedEvent>, IEventStore
    {
        ...
        public EventStore()
        {
            ...
            news = DependencyService.Get<INewsStore>();
        }
        ...
        public override async Task InitializeStore()
        {
            ...
            var newsList = await news.GetItemsAsync();
            ...
            Events.Add (new FeaturedEvent {
                Title = "Darwin Lounge",
                Description = "Stocked full of tech toys, massage chairs, Xamarin engineers, and a few really cool surprises, the Darwin Lounge is your place to hang out and relax between lockers. Back by popular demand, we’ll have several code challenges—Mini-Hacks—for you to complete to earn awesome prizes.",
            ...
            Events.Add(new FeaturedEvent
                {
                    ...
                    IsAllDay = false,
                   // News = newsList.FirstOrDefault(x => x.Name == "Microsoft")
                });
            ...
            Events.Add(new FeaturedEvent
                {
                    Title = "Closing Locker & Xammy Awards",
                    Description = "",
