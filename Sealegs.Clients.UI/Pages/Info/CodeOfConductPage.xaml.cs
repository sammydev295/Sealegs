...
namespace Sealegs.Clients.UI
{
    public partial class CodeOfConductPage : ContentPage
    {
        public static string Conduct = "We want Xamarin Evolve 2016 to be the best conference you’ve ever attended. In addition to great content, technical training, networking opportunities, and fun events, we want to make sure the conference is a safe and productive environment for all participants." +
            ...
            "\n\nExhibitors in the expo hall, or similar activities are also subject to this code of conduct. In particular, exhibitors should not use sexualized images, activities, or other material. Booth staff (including volunteers) should not use sexualized clothing/uniforms/costumes, or otherwise create a sexualized environment." +
