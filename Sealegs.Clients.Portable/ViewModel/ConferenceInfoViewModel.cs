...
namespace Sealegs.Clients.Portable
{
    ...
    public class ConferenceInfoViewModel : BaseViewModel
    {
        ...
        void ExecuteConfigureWiFiCommand()
        {
            ...
            Logger.Track(SealegsLoggerKeys.WiFiConfig, "Type", "2.4Ghz");
        ...
        {
            Logger.Track(SealegsLoggerKeys.CopyPassword);
