...
namespace Sealegs.Clients.Portable
{
    public class SettingsViewModel : BaseViewModel
    {
        ...
        void ExecuteLoginCommand()
        {
            ...
            if (Settings.IsLoggedIn)
            {
                MessagingService.Current.SendMessage<MessagingServiceQuestion>(MessageKeys.Question, new MessagingServiceQuestion
                    {
                        Title = "Logout?",
                        Question = "Are you sure you want to logout? You can only save favorites and leave feed" +
                                   "" +
                                   "back when logged in.",
                        Positive = "Yes, Logout",
                        Negative = "Cancel",
        ...
        async Task Logout()
        {
            Logger.Track(SealegsLoggerKeys.Logout);
        ...
        async Task ExecuteSyncCommandAsync()
        {
            ...
            Logger.Track(SealegsLoggerKeys.ManualSync);
                    ...
                    MessagingService.Current.SendMessage<MessagingServiceAlert>(MessageKeys.Message, new MessagingServiceAlert
                        {
                            ...
                            Message = "You now have the latest conference data, however to sync your favorites and feedback you must sign in with your Sealegs account.",
                            Cancel = "OK"
                        });
                }
