...
namespace Sealegs.Clients.Portable.Auth
{
    public class XamarinSSOClient : ISSOClient
    {
        ...
        public XamarinSSOClient(string apiKey)
        {
            client = new HttpClient
                {
                    BaseAddress = new Uri(@"https://sealegs.azurewebsites.net/.auth/login/sealegsauth")
                };
        ...
        {
            // Since this is mock mode just return a summy User account object
