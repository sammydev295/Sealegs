...
namespace Sealegs.UITests
{
    ...
    {
        const string apkfile = "../../../Sealegs.Android/bin/UITest/com.sample.evolve-Signed.apk";
        //        const string appfile = "../../../Sealegs.iOS/bin/iPhoneSimulator/Debug/XamarinEvolveiOS.app";
