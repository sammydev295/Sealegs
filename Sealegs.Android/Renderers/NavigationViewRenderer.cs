...
[assembly: ExportRenderer (typeof(Sealegs.Clients.UI.NavigationView), typeof(NavigationViewRenderer))]
namespace Sealegs.Droid
{
    public class NavigationViewRenderer : ViewRenderer<Sealegs.Clients.UI.NavigationView, NavigationView>
    {
        NavigationView navView;
        ImageView profileImage;
        TextView profileName;

        protected override void OnElementChanged(ElementChangedEventArgs<Sealegs.Clients.UI.NavigationView> e)
        {
            ...
            navView.SetCheckedItem(Resource.Id.nav_lockers);
        }
        ...
        void NavigateToLogin()
        {
            ...
            Sealegs.Clients.UI.App.Logger.TrackPage(AppPage.Login.ToString(), "navigation");
        ...
        void NavView_NavigationItemSelected (object sender, NavigationView.NavigationItemSelectedEventArgs e)
        {
            ...
            {
                case Resource.Id.nav_lockers:
                    id = (int)AppPage.Lockers;
                    break;
                case Resource.Id.nav_employees:
                    id = (int) AppPage.Employees;
                    break;
            ...
            this.Element.OnNavigationItemSelected(new Sealegs.Clients.UI.NavigationItemSelectedEventArgs
            {
                Index = id
            });
        }
