...
using Xamarin.Forms;
using Sealegs.Clients;
using Sealegs.Clients.Portable;
using Sealegs.DataStore.Abstractions;

namespace Sealegs.Droid
{
    [Service (Name="com.xamarin.Sealegs.DataRefreshService", Exported = true, Permission = "com.google.android.gms.permission.BIND_NETWORK_TASK_SERVICE")]
        ...
        public static void ScheduleRefresh (Context context)
        {
            try
            {
                ...
                var pt = new PeriodicTask.Builder ()
                    ...
                    .SetTag ("com.xamarin.Sealegs.backgrounddatarefresh")
                    .SetPersisted (true)
